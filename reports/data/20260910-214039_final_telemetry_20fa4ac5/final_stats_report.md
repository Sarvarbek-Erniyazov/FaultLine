...
| --- | --- | --- |
| ambient_temp_c | 2,188 | 0.015% |
| gearbox_bearing_temp_c | 519 | 0.003% |
| gearbox_oil_temp_c | 2,070 | 0.014% |
| generator_bearing_temp_c | 1,813 | 0.012% |
| generator_speed_rpm | 18,059 | 0.121% |
| generator_winding_temp_c | 1,832 | 0.012% |
| main_bearing_temp_c | 1,623 | 0.011% |
| nacelle_position_deg | 1,907 | 0.013% |
| nacelle_temp_c | 2,079 | 0.014% |
| pitch_angle_deg | 2,267 | 0.015% |
| power_kw | 1,934 | 0.013% |
| rotor_speed_rpm | 4,028 | 0.027% |
