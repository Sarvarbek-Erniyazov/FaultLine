...
| --- | --- | --- | --- | --- | --- |
| ADR-0021 | The held-out-site gate: `tel_only` at full budget must put Hill of Towie's AUPRC interval... | pre-registered 2026-09-16 | `ce9c8ad` | NOT EVALUABLE; leave-site-out is a reported negative, and the fallback is chosen under ADR-0022 | `ed60e8d` |
| ADR-0022 | The primary evaluation axis after ADR-0021: the selection rule, the CARE facts and scoring... | registered 2026-09-17 | `801ab71` | CARE is NOT EVALUABLE at chance on all three seeds; the in-distribution temporal split is... | `d87a524` |
...
| ADR-0024 | The probe-sensitivity criterion is a paired test, and a bag-of-tokens comparator is reported... | pre-registered 2026-09-17 | `79d4e97` | PASS: the final-position frozen probe sees the pretrained backbone; §a is the probe in force | `f6c2df0` |
